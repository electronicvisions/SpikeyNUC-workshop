...
\title{Tutorial: BrainScaleS Neuromorphic Hardware}
\subtitle{HBP Summit 2017}

\date{\today}
\author{Eric Müller, Andreas Grübl}
\institute{Kirchhoff-Institute for Physics, Heidelberg University\\
\url{https://github.com/electronicvisions/SpikeyNUC-workshop}}
...
\titlegraphic{%
	%\includegraphics[width=2cm]{logo_spikey}\hspace*{4.75cm}~%
	\phantom{a}\hspace{\fill}\includegraphics[width=2cm]{visions_logo.png}%
	\vspace{1.5\baselineskip}%
	\newline%
	\phantom{a}\hspace{\fill}\includegraphics[width=2cm]{spikey_logo.png}%
}
...
\includepdf[pages=1]{HBP_Summit_Template.pdf}
}

{
	\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight,page=2]{HBP_Summit_Template.pdf}%HBP_Summit_Template_Slide_BG.png}%
}
...
\begin{frame}{Information}
	\begin{columns}[onlytextwidth]
		\begin{column}{0.55\textwidth}
			\textbf{Wifi:} \\
			ESSIDs:
			\texttt{DemoBrainScaleS},
			\texttt{DemoBrainScaleS1},
			\texttt{DemoBrainScaleS2}\\
			Password: \texttt{BrainScaleS}

			\vspace{3ex}

			\textbf{Jupyter notebook hub:} \\
			\url{http://192.168.0.212}\\
			(Pick a username, password is \texttt{BrainScaleS})
		\end{column}
		\hfill
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{assets/six_column_background.pdf}}%
\begin{frame}[fragile]
	\frametitle{Roadmap}
	...
	\begin{columns}[T]
		\column{0.15\paperwidth}
		\begin{center}
			\textbf{\color{mDarkTeal}Spikey \phantom{longlong}}
		\begin{itemize}
		...
		\column{0.15\paperwidth}
		\begin{center}
			\textbf{\color{mDarkTeal}HICANN \phantom{longlong}}
		\begin{itemize}
			\item[] \SI{180}{\nano\meter} CMOS
		...
		\begin{itemize}
			\item[] \SI{65}{\nano\meter} CMOS
			\item[] 32 neurons
			\item[] integrated CPU for programmable plasticity
		\end{itemize}
		\end{center}

		\column{0.15\paperwidth}
		\begin{center}
			\textbf{\color{mDarkTeal}HICANN DLS-SR}
		\begin{itemize}
			\item[] O(512) neurons
		\end{itemize}
		\end{center}
